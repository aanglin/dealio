...
function TopBar() {
  ...
  return (
    <div className="pb-28">
    <div className="fixed flex justify-start items-center text-xl  pl-3 bg-[#64D4D9] w-full h-[5rem] z-50">
      <div className="flex items-center">
        ...
        <div className='flex'>
        <Link href={'/'} className="flex px-11 items-center md:pl-[23rem] lg:p-36 lg:px-20">
